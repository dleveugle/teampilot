...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(8262062841413280)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(8262160548413280)
,p_plug_name=>'Buttons'
,p_region_template_options=>'#DEFAULT#'
,p_escape_on_http_output=>'Y'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(8263351091413278)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(8262160548413280)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(8263653304413278)
...
wwv_flow_imp_page.create_page_branch(
 p_id=>wwv_flow_imp.id(8265081476413275)
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(8265321154413274)
,p_name=>'P10010_ALLOW_OTHER_USERS'
,p_is_required=>true
,p_item_sequence=>30
,p_item_plug_id=>wwv_flow_imp.id(8262062841413280)
...
,p_field_template=>wwv_flow_imp.id(8131747507413450)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(8263712911413278)
,p_name=>'Cancel Dialog'
,p_event_sequence=>10
,p_triggering_element_type=>'BUTTON'
,p_triggering_button_id=>wwv_flow_imp.id(8263653304413278)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(8264466321413276)
,p_event_id=>wwv_flow_imp.id(8263712911413278)
,p_event_result=>'TRUE'
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(8265737523413274)
...
,p_internal_uid=>8265737523413274
);
