...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(8266133901413273)
...
wwv_flow_imp_page.create_worksheet(
 p_id=>wwv_flow_imp.id(8266932726413271)
,p_name=>'Manage User Access'
...
,p_owner=>'TP'
,p_internal_uid=>8266932726413271
);
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(8267623404413262)
,p_db_column_name=>'ID'
,p_display_order=>0
,p_is_primary_key=>'Y'
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(8268043128413260)
...
wwv_flow_imp_page.create_worksheet_column(
 p_id=>wwv_flow_imp.id(8268405748413260)
...
wwv_flow_imp_page.create_worksheet_rpt(
 p_id=>wwv_flow_imp.id(8270030417413257)
,p_application_user=>'APXWS_DEFAULT'
,p_report_seq=>10
,p_report_alias=>'82701'
,p_status=>'PUBLIC'
,p_is_default=>'Y'
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(8270946933413255)
,p_button_sequence=>20
,p_button_plug_id=>wwv_flow_imp.id(8266133901413273)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(8271308825413255)
...
wwv_flow_imp_page.create_page_button(
 p_id=>wwv_flow_imp.id(8271797256413254)
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(8266243778413273)
,p_name=>'Refresh Report'
,p_event_sequence=>10
,p_triggering_element_type=>'REGION'
,p_triggering_region_id=>wwv_flow_imp.id(8266133901413273)
,p_bind_type=>'bind'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'apexafterclosedialog'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(8272359565413254)
,p_event_id=>wwv_flow_imp.id(8266243778413273)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_REFRESH'
,p_affected_elements_type=>'REGION'
,p_affected_region_id=>wwv_flow_imp.id(8266133901413273)
);
