...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(8164483638413406)
...
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1935402237787485098)
,p_plugin_id=>wwv_flow_imp.id(8164483638413406)
,p_title=>'Avatar'
,p_display_sequence=>10
);
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1935401682775485097)
,p_plugin_id=>wwv_flow_imp.id(8164483638413406)
,p_title=>'Badge'
,p_display_sequence=>20
);
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1678509619045211584)
,p_plugin_id=>wwv_flow_imp.id(8164483638413406)
,p_title=>'Appearance'
,p_display_sequence=>30
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8165311452413402)
,p_plugin_id=>wwv_flow_imp.id(8164483638413406)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8165641060413401)
,p_plugin_id=>wwv_flow_imp.id(8164483638413406)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8165976481413401)
,p_plugin_id=>wwv_flow_imp.id(8164483638413406)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8166202416413401)
,p_plugin_id=>wwv_flow_imp.id(8164483638413406)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8166581664413400)
,p_plugin_id=>wwv_flow_imp.id(8164483638413406)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8166889890413400)
,p_plugin_id=>wwv_flow_imp.id(8164483638413406)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8167173770413400)
,p_plugin_id=>wwv_flow_imp.id(8164483638413406)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(8166581664413400)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_lov_type=>'STATIC'
,p_attribute_group_id=>wwv_flow_imp.id(1935402237787485098)
,p_help_text=>'Select the type of content that will be displayed in the avatar.'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8167410892413399)
,p_plugin_attribute_id=>wwv_flow_imp.id(8167173770413400)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'image'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8167802072413399)
,p_plugin_attribute_id=>wwv_flow_imp.id(8167173770413400)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8168230930413398)
,p_plugin_attribute_id=>wwv_flow_imp.id(8167173770413400)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8168658444413398)
,p_plugin_id=>wwv_flow_imp.id(8164483638413406)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(8167173770413400)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8168909830413398)
,p_plugin_id=>wwv_flow_imp.id(8164483638413406)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8169284784413397)
,p_plugin_id=>wwv_flow_imp.id(8164483638413406)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8169546639413397)
,p_plugin_id=>wwv_flow_imp.id(8164483638413406)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8169870343413397)
,p_plugin_id=>wwv_flow_imp.id(8164483638413406)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8170185717413396)
,p_plugin_attribute_id=>wwv_flow_imp.id(8169870343413397)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8170527063413396)
,p_plugin_attribute_id=>wwv_flow_imp.id(8169870343413397)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8170994517413396)
,p_plugin_attribute_id=>wwv_flow_imp.id(8169870343413397)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8171300569413395)
,p_plugin_attribute_id=>wwv_flow_imp.id(8169870343413397)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8171783623413395)
,p_plugin_id=>wwv_flow_imp.id(8164483638413406)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'RAW'
,p_is_translatable=>true
,p_depending_on_attribute_id=>wwv_flow_imp.id(8166889890413400)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_attribute_group_id=>wwv_flow_imp.id(1935401682775485097)
,p_help_text=>'Enter a value for the badge label or select a source column from the quick pick options.'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8172067613413395)
,p_plugin_id=>wwv_flow_imp.id(8164483638413406)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8172392108413394)
,p_plugin_id=>wwv_flow_imp.id(8164483638413406)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8172662592413394)
,p_plugin_id=>wwv_flow_imp.id(8164483638413406)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8172953560413394)
,p_plugin_id=>wwv_flow_imp.id(8164483638413406)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8173256780413394)
,p_plugin_id=>wwv_flow_imp.id(8164483638413406)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8173564891413393)
,p_plugin_attribute_id=>wwv_flow_imp.id(8173256780413394)
,p_display_sequence=>10
,p_display_value=>'Subtle'
,p_return_value=>'t-Badge--subtle'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8173991849413393)
,p_plugin_attribute_id=>wwv_flow_imp.id(8173256780413394)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8174314634413392)
,p_plugin_id=>wwv_flow_imp.id(8164483638413406)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8174655856413392)
,p_plugin_attribute_id=>wwv_flow_imp.id(8174314634413392)
,p_display_sequence=>10
,p_display_value=>'Rounded'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8175071530413392)
,p_plugin_attribute_id=>wwv_flow_imp.id(8174314634413392)
,p_display_sequence=>20
,p_display_value=>'Circular'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8175424339413391)
,p_plugin_attribute_id=>wwv_flow_imp.id(8174314634413392)
,p_display_sequence=>30
,p_display_value=>'Square'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8175841724413391)
,p_plugin_attribute_id=>wwv_flow_imp.id(8174314634413392)
,p_display_sequence=>40
,p_display_value=>'No Shape'
,p_return_value=>'t-Avatar--noShape'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8176200495413391)
,p_plugin_id=>wwv_flow_imp.id(8164483638413406)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8176569238413390)
,p_plugin_attribute_id=>wwv_flow_imp.id(8176200495413391)
,p_display_sequence=>10
,p_display_value=>'Extra Extra Small'
,p_return_value=>'t-Avatar--xxs'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8176939986413390)
,p_plugin_attribute_id=>wwv_flow_imp.id(8176200495413391)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8177329760413390)
,p_plugin_attribute_id=>wwv_flow_imp.id(8176200495413391)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8177739236413389)
,p_plugin_attribute_id=>wwv_flow_imp.id(8176200495413391)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8178162018413388)
,p_plugin_attribute_id=>wwv_flow_imp.id(8176200495413391)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8178555068413388)
,p_plugin_attribute_id=>wwv_flow_imp.id(8176200495413391)
,p_display_sequence=>60
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8178999425413387)
,p_plugin_attribute_id=>wwv_flow_imp.id(8176200495413391)
,p_display_sequence=>70
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8179391928413387)
,p_plugin_id=>wwv_flow_imp.id(8164483638413406)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8179656720413387)
,p_plugin_attribute_id=>wwv_flow_imp.id(8179391928413387)
,p_display_sequence=>10
,p_display_value=>'Small'
,p_return_value=>'t-Badge--sm'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8180021350413386)
,p_plugin_attribute_id=>wwv_flow_imp.id(8179391928413387)
,p_display_sequence=>20
,p_display_value=>'Medium'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8180411799413386)
,p_plugin_attribute_id=>wwv_flow_imp.id(8179391928413387)
,p_display_sequence=>30
,p_display_value=>'Large'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8180812950413385)
,p_plugin_id=>wwv_flow_imp.id(8164483638413406)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8181162074413385)
,p_plugin_attribute_id=>wwv_flow_imp.id(8180812950413385)
,p_display_sequence=>10
,p_display_value=>'Small'
,p_return_value=>'t-ContentRow-badge--sm'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8181538440413385)
,p_plugin_attribute_id=>wwv_flow_imp.id(8180812950413385)
,p_display_sequence=>20
,p_display_value=>'Medium'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8181987655413384)
,p_plugin_attribute_id=>wwv_flow_imp.id(8180812950413385)
,p_display_sequence=>30
,p_display_value=>'Large'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8182388106413384)
,p_plugin_attribute_id=>wwv_flow_imp.id(8180812950413385)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8182791986413384)
,p_plugin_id=>wwv_flow_imp.id(8164483638413406)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8183096741413383)
,p_plugin_attribute_id=>wwv_flow_imp.id(8182791986413384)
,p_display_sequence=>10
,p_display_value=>'End'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8183471837413383)
,p_plugin_id=>wwv_flow_imp.id(8164483638413406)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8183703733413383)
,p_plugin_attribute_id=>wwv_flow_imp.id(8183471837413383)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8184116734413382)
,p_plugin_attribute_id=>wwv_flow_imp.id(8183471837413383)
,p_display_sequence=>20
,p_display_value=>'End'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8184570308413382)
,p_plugin_id=>wwv_flow_imp.id(8164483638413406)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8184890531413382)
,p_plugin_id=>wwv_flow_imp.id(8164483638413406)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8185130670413381)
,p_plugin_id=>wwv_flow_imp.id(8164483638413406)
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_attribute_group_id=>wwv_flow_imp.id(1678509619045211584)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8185480139413381)
,p_plugin_id=>wwv_flow_imp.id(8164483638413406)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8185760575413381)
,p_plugin_attribute_id=>wwv_flow_imp.id(8185480139413381)
,p_display_sequence=>10
,p_display_value=>'Compact'
,p_return_value=>'t-ContentRow--styleCompact'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8186184878413380)
,p_plugin_id=>wwv_flow_imp.id(8164483638413406)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8186443784413380)
,p_plugin_id=>wwv_flow_imp.id(8164483638413406)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_act_template(
 p_id=>wwv_flow_imp.id(1816616128003306712)
,p_plugin_id=>wwv_flow_imp.id(8164483638413406)
,p_name=>'Button'
,p_type=>'BUTTON'
...
wwv_flow_imp_shared.create_plugin_act_template(
 p_id=>wwv_flow_imp.id(1816617387523310860)
,p_plugin_id=>wwv_flow_imp.id(8164483638413406)
,p_name=>'Menu'
,p_type=>'MENU'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1519664613107548282)
,p_plugin_id=>wwv_flow_imp.id(8164483638413406)
,p_name=>'Badge Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1803022499328899979)
,p_plugin_id=>wwv_flow_imp.id(8164483638413406)
,p_name=>'Title Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1803701800058983083)
,p_plugin_id=>wwv_flow_imp.id(8164483638413406)
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1816614192936261726)
,p_plugin_id=>wwv_flow_imp.id(8164483638413406)
,p_name=>'Avatar Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1816615526326275583)
,p_plugin_id=>wwv_flow_imp.id(8164483638413406)
