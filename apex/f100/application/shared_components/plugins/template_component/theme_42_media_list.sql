...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(8191744949413350)
...
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1808210175481296996)
,p_plugin_id=>wwv_flow_imp.id(8191744949413350)
,p_title=>'Avatar'
,p_display_sequence=>10
);
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(1808209620469296995)
,p_plugin_id=>wwv_flow_imp.id(8191744949413350)
,p_title=>'Badge'
,p_display_sequence=>20
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8192417981413346)
,p_plugin_id=>wwv_flow_imp.id(8191744949413350)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8192759986413346)
,p_plugin_id=>wwv_flow_imp.id(8191744949413350)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8193006461413346)
,p_plugin_id=>wwv_flow_imp.id(8191744949413350)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8193348203413345)
,p_plugin_id=>wwv_flow_imp.id(8191744949413350)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8193686554413345)
,p_plugin_id=>wwv_flow_imp.id(8191744949413350)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(8193006461413346)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_lov_type=>'STATIC'
,p_attribute_group_id=>wwv_flow_imp.id(1808210175481296996)
,p_help_text=>'Select the type of content that will be displayed in the avatar.'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8193910682413345)
,p_plugin_attribute_id=>wwv_flow_imp.id(8193686554413345)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'image'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8194366363413345)
,p_plugin_attribute_id=>wwv_flow_imp.id(8193686554413345)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8194734463413344)
,p_plugin_attribute_id=>wwv_flow_imp.id(8193686554413345)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8195100791413344)
,p_plugin_id=>wwv_flow_imp.id(8191744949413350)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(8193686554413345)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8195407671413343)
,p_plugin_id=>wwv_flow_imp.id(8191744949413350)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8195761405413343)
,p_plugin_id=>wwv_flow_imp.id(8191744949413350)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8196086188413343)
,p_plugin_id=>wwv_flow_imp.id(8191744949413350)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8196354288413342)
,p_plugin_id=>wwv_flow_imp.id(8191744949413350)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8196646052413342)
,p_plugin_attribute_id=>wwv_flow_imp.id(8196354288413342)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8197009581413342)
,p_plugin_attribute_id=>wwv_flow_imp.id(8196354288413342)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8197475190413341)
,p_plugin_attribute_id=>wwv_flow_imp.id(8196354288413342)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8197810669413341)
,p_plugin_attribute_id=>wwv_flow_imp.id(8196354288413342)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8198227993413341)
,p_plugin_id=>wwv_flow_imp.id(8191744949413350)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'RAW'
,p_is_translatable=>true
,p_depending_on_attribute_id=>wwv_flow_imp.id(8193348203413345)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_attribute_group_id=>wwv_flow_imp.id(1808209620469296995)
,p_help_text=>'Enter a value for the badge label or select a source column from the quick pick options.'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8198551060413340)
,p_plugin_id=>wwv_flow_imp.id(8191744949413350)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8198877548413340)
,p_plugin_id=>wwv_flow_imp.id(8191744949413350)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8199189123413340)
,p_plugin_id=>wwv_flow_imp.id(8191744949413350)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8199413619413339)
,p_plugin_id=>wwv_flow_imp.id(8191744949413350)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8199700424413339)
,p_plugin_id=>wwv_flow_imp.id(8191744949413350)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8200032900413339)
,p_plugin_attribute_id=>wwv_flow_imp.id(8199700424413339)
,p_display_sequence=>10
,p_display_value=>'Subtle'
,p_return_value=>'t-Badge--subtle'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8200454382413338)
,p_plugin_attribute_id=>wwv_flow_imp.id(8199700424413339)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8200865478413338)
,p_plugin_id=>wwv_flow_imp.id(8191744949413350)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8201123521413338)
,p_plugin_attribute_id=>wwv_flow_imp.id(8200865478413338)
,p_display_sequence=>10
,p_display_value=>'Rounded'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8201586280413337)
,p_plugin_attribute_id=>wwv_flow_imp.id(8200865478413338)
,p_display_sequence=>20
,p_display_value=>'Circular'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8201926885413337)
,p_plugin_attribute_id=>wwv_flow_imp.id(8200865478413338)
,p_display_sequence=>30
,p_display_value=>'Square'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8202354699413337)
,p_plugin_id=>wwv_flow_imp.id(8191744949413350)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8202681611413336)
,p_plugin_attribute_id=>wwv_flow_imp.id(8202354699413337)
,p_display_sequence=>10
,p_display_value=>'2 Column Grid'
,p_return_value=>'t-MediaList--cols t-MediaList--2cols'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8203025767413336)
,p_plugin_attribute_id=>wwv_flow_imp.id(8202354699413337)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8203492212413336)
,p_plugin_attribute_id=>wwv_flow_imp.id(8202354699413337)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8203838775413335)
,p_plugin_attribute_id=>wwv_flow_imp.id(8202354699413337)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8204224884413335)
,p_plugin_attribute_id=>wwv_flow_imp.id(8202354699413337)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8204671467413335)
,p_plugin_id=>wwv_flow_imp.id(8191744949413350)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8204908268413334)
,p_plugin_attribute_id=>wwv_flow_imp.id(8204671467413335)
,p_display_sequence=>10
,p_display_value=>'Large'
,p_return_value=>'t-MediaList--large force-fa-lg'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8205383064413334)
,p_plugin_id=>wwv_flow_imp.id(8191744949413350)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1808413227638443624)
,p_plugin_id=>wwv_flow_imp.id(8191744949413350)
,p_name=>'Link'
,p_static_id=>'LINK'
,p_display_sequence=>10
