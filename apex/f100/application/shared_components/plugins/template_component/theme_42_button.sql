...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(8151674967413426)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8151939500413425)
,p_plugin_id=>wwv_flow_imp.id(8151674967413426)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8152234113413425)
,p_plugin_id=>wwv_flow_imp.id(8151674967413426)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8152514351413425)
,p_plugin_id=>wwv_flow_imp.id(8151674967413426)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8152802177413425)
,p_plugin_id=>wwv_flow_imp.id(8151674967413426)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8153137871413424)
,p_plugin_id=>wwv_flow_imp.id(8151674967413426)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8153406237413424)
,p_plugin_id=>wwv_flow_imp.id(8151674967413426)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8153785677413424)
,p_plugin_id=>wwv_flow_imp.id(8151674967413426)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8154004577413423)
,p_plugin_id=>wwv_flow_imp.id(8151674967413426)
,p_attribute_scope=>'COMPONENT'
