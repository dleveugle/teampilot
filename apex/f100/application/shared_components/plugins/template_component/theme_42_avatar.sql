...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(8136487434413447)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8136749756413445)
,p_plugin_id=>wwv_flow_imp.id(8136487434413447)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8137016819413444)
,p_plugin_attribute_id=>wwv_flow_imp.id(8136749756413445)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'IMAGE'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8137427303413444)
,p_plugin_attribute_id=>wwv_flow_imp.id(8136749756413445)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8137885057413443)
,p_plugin_attribute_id=>wwv_flow_imp.id(8136749756413445)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8138210875413443)
,p_plugin_id=>wwv_flow_imp.id(8136487434413447)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(8136749756413445)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8138550849413442)
,p_plugin_id=>wwv_flow_imp.id(8136487434413447)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8138833974413442)
,p_plugin_id=>wwv_flow_imp.id(8136487434413447)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8139110663413442)
,p_plugin_id=>wwv_flow_imp.id(8136487434413447)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8139440009413441)
,p_plugin_id=>wwv_flow_imp.id(8136487434413447)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8139717254413440)
,p_plugin_attribute_id=>wwv_flow_imp.id(8139440009413441)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8140152599413440)
,p_plugin_attribute_id=>wwv_flow_imp.id(8139440009413441)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8140501600413439)
,p_plugin_attribute_id=>wwv_flow_imp.id(8139440009413441)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8140983634413439)
,p_plugin_attribute_id=>wwv_flow_imp.id(8139440009413441)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8141314087413438)
,p_plugin_id=>wwv_flow_imp.id(8136487434413447)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8141684749413438)
,p_plugin_attribute_id=>wwv_flow_imp.id(8141314087413438)
,p_display_sequence=>10
,p_display_value=>'Extra Extra Small'
,p_return_value=>'t-Avatar--xxs'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8142070958413438)
,p_plugin_attribute_id=>wwv_flow_imp.id(8141314087413438)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8142425038413437)
,p_plugin_attribute_id=>wwv_flow_imp.id(8141314087413438)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8142826363413437)
,p_plugin_attribute_id=>wwv_flow_imp.id(8141314087413438)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8143292242413437)
,p_plugin_attribute_id=>wwv_flow_imp.id(8141314087413438)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8143694799413436)
,p_plugin_attribute_id=>wwv_flow_imp.id(8141314087413438)
,p_display_sequence=>60
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(8144099346413436)
,p_plugin_attribute_id=>wwv_flow_imp.id(8141314087413438)
,p_display_sequence=>70
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(8144451361413435)
,p_plugin_id=>wwv_flow_imp.id(8136487434413447)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(1808187315746527197)
,p_plugin_id=>wwv_flow_imp.id(8136487434413447)
,p_name=>'Link'
,p_static_id=>'LINK'
,p_display_sequence=>10
