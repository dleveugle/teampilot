...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(7961227037413519)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7961549716413519)
,p_page_template_id=>wwv_flow_imp.id(7961227037413519)
,p_name=>'After Logo'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7961893278413518)
,p_page_template_id=>wwv_flow_imp.id(7961227037413519)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7962106214413518)
,p_page_template_id=>wwv_flow_imp.id(7961227037413519)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7962491158413518)
,p_page_template_id=>wwv_flow_imp.id(7961227037413519)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7962739468413518)
,p_page_template_id=>wwv_flow_imp.id(7961227037413519)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7963099588413518)
,p_page_template_id=>wwv_flow_imp.id(7961227037413519)
,p_name=>'Left Column'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7963356522413518)
,p_page_template_id=>wwv_flow_imp.id(7961227037413519)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7963656246413518)
,p_page_template_id=>wwv_flow_imp.id(7961227037413519)
,p_name=>'Footer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7963980318413518)
,p_page_template_id=>wwv_flow_imp.id(7961227037413519)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7964217391413518)
,p_page_template_id=>wwv_flow_imp.id(7961227037413519)
,p_name=>'Banner'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7964511966413517)
,p_page_template_id=>wwv_flow_imp.id(7961227037413519)
