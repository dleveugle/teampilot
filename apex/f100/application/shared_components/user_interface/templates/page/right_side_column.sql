...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(7980403300413511)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7980723942413511)
,p_page_template_id=>wwv_flow_imp.id(7980403300413511)
,p_name=>'After Logo'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7981072793413511)
,p_page_template_id=>wwv_flow_imp.id(7980403300413511)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7981330383413511)
,p_page_template_id=>wwv_flow_imp.id(7980403300413511)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7981648514413511)
,p_page_template_id=>wwv_flow_imp.id(7980403300413511)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7981919785413511)
,p_page_template_id=>wwv_flow_imp.id(7980403300413511)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7982238536413510)
,p_page_template_id=>wwv_flow_imp.id(7980403300413511)
,p_name=>'Right Column'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7982569579413510)
,p_page_template_id=>wwv_flow_imp.id(7980403300413511)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7982895523413510)
,p_page_template_id=>wwv_flow_imp.id(7980403300413511)
,p_name=>'Footer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7983121135413510)
,p_page_template_id=>wwv_flow_imp.id(7980403300413511)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7983438871413510)
,p_page_template_id=>wwv_flow_imp.id(7980403300413511)
,p_name=>'Banner'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7983759384413510)
,p_page_template_id=>wwv_flow_imp.id(7980403300413511)
