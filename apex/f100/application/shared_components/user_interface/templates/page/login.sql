...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(7968907722413516)
,p_theme_id=>42
,p_name=>'Login'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7969259124413516)
,p_page_template_id=>wwv_flow_imp.id(7968907722413516)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7969587990413516)
,p_page_template_id=>wwv_flow_imp.id(7968907722413516)
,p_name=>'Content Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7969852213413515)
,p_page_template_id=>wwv_flow_imp.id(7968907722413516)
,p_name=>'Body Header'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7970154275413515)
,p_page_template_id=>wwv_flow_imp.id(7968907722413516)
,p_name=>'Body Footer'
