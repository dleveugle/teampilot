...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(7975536233413513)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7975884876413513)
,p_page_template_id=>wwv_flow_imp.id(7975536233413513)
,p_name=>'After Logo'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7976121987413513)
,p_page_template_id=>wwv_flow_imp.id(7975536233413513)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7976475507413513)
,p_page_template_id=>wwv_flow_imp.id(7975536233413513)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7976743141413513)
,p_page_template_id=>wwv_flow_imp.id(7975536233413513)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7977054123413513)
,p_page_template_id=>wwv_flow_imp.id(7975536233413513)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7977311974413513)
,p_page_template_id=>wwv_flow_imp.id(7975536233413513)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7977687715413513)
,p_page_template_id=>wwv_flow_imp.id(7975536233413513)
,p_name=>'Footer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7977980175413512)
,p_page_template_id=>wwv_flow_imp.id(7975536233413513)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7978266036413512)
,p_page_template_id=>wwv_flow_imp.id(7975536233413513)
,p_name=>'Banner'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7978564778413512)
,p_page_template_id=>wwv_flow_imp.id(7975536233413513)
