...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(7984158659413510)
,p_theme_id=>42
,p_name=>'Standard'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7984449125413509)
,p_page_template_id=>wwv_flow_imp.id(7984158659413510)
,p_name=>'After Logo'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7984788775413509)
,p_page_template_id=>wwv_flow_imp.id(7984158659413510)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7985094243413509)
,p_page_template_id=>wwv_flow_imp.id(7984158659413510)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7985395243413509)
,p_page_template_id=>wwv_flow_imp.id(7984158659413510)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7985642551413509)
,p_page_template_id=>wwv_flow_imp.id(7984158659413510)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7985993423413509)
,p_page_template_id=>wwv_flow_imp.id(7984158659413510)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7986252135413509)
,p_page_template_id=>wwv_flow_imp.id(7984158659413510)
,p_name=>'Footer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7986507358413509)
,p_page_template_id=>wwv_flow_imp.id(7984158659413510)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7986894277413509)
,p_page_template_id=>wwv_flow_imp.id(7984158659413510)
,p_name=>'Banner'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7987125045413508)
,p_page_template_id=>wwv_flow_imp.id(7984158659413510)
