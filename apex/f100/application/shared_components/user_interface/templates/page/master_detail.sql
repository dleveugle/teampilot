...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(7971568728413515)
,p_theme_id=>42
,p_name=>'Marquee'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7971810831413515)
,p_page_template_id=>wwv_flow_imp.id(7971568728413515)
,p_name=>'After Logo'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7972151019413515)
,p_page_template_id=>wwv_flow_imp.id(7971568728413515)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7972449219413514)
,p_page_template_id=>wwv_flow_imp.id(7971568728413515)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7972788830413514)
,p_page_template_id=>wwv_flow_imp.id(7971568728413515)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7973093150413514)
,p_page_template_id=>wwv_flow_imp.id(7971568728413515)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7973320451413514)
,p_page_template_id=>wwv_flow_imp.id(7971568728413515)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7973637949413514)
,p_page_template_id=>wwv_flow_imp.id(7971568728413515)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7973913463413514)
,p_page_template_id=>wwv_flow_imp.id(7971568728413515)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7974291680413514)
,p_page_template_id=>wwv_flow_imp.id(7971568728413515)
,p_name=>'Footer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7974533817413514)
,p_page_template_id=>wwv_flow_imp.id(7971568728413515)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7974849009413514)
,p_page_template_id=>wwv_flow_imp.id(7971568728413515)
,p_name=>'Banner'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(7975105120413514)
,p_page_template_id=>wwv_flow_imp.id(7971568728413515)
