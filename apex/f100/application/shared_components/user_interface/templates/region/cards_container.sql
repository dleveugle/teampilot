...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(8001358783413502)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8001691275413502)
,p_plug_template_id=>wwv_flow_imp.id(8001358783413502)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8001978407413502)
,p_plug_template_id=>wwv_flow_imp.id(8001358783413502)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8002217276413502)
,p_plug_template_id=>wwv_flow_imp.id(8001358783413502)
,p_name=>'Sub Regions'
