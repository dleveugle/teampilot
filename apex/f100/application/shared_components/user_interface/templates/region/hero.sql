...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(8027542339413492)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8027888786413492)
,p_plug_template_id=>wwv_flow_imp.id(8027542339413492)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8028125829413492)
,p_plug_template_id=>wwv_flow_imp.id(8027542339413492)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8028472688413492)
,p_plug_template_id=>wwv_flow_imp.id(8027542339413492)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8028774580413492)
,p_plug_template_id=>wwv_flow_imp.id(8027542339413492)
,p_name=>'Sub Regions'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8029011809413492)
,p_plug_template_id=>wwv_flow_imp.id(8027542339413492)
,p_name=>'Up'
,p_placeholder=>'UP'
,p_has_grid_support=>false
