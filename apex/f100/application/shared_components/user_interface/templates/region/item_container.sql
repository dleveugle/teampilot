...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(8053139098413482)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8053437992413482)
,p_plug_template_id=>wwv_flow_imp.id(8053139098413482)
,p_name=>'Item'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8053717449413482)
,p_plug_template_id=>wwv_flow_imp.id(8053139098413482)
,p_name=>'Button End'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8054008101413482)
,p_plug_template_id=>wwv_flow_imp.id(8053139098413482)
,p_name=>'Button Start'
