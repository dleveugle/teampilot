...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(8041003319413487)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8041373312413487)
,p_plug_template_id=>wwv_flow_imp.id(8041003319413487)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8041604215413487)
,p_plug_template_id=>wwv_flow_imp.id(8041003319413487)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8041948296413487)
,p_plug_template_id=>wwv_flow_imp.id(8041003319413487)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8042292942413487)
,p_plug_template_id=>wwv_flow_imp.id(8041003319413487)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8042519914413487)
,p_plug_template_id=>wwv_flow_imp.id(8041003319413487)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8042893280413486)
,p_plug_template_id=>wwv_flow_imp.id(8041003319413487)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8043151234413486)
,p_plug_template_id=>wwv_flow_imp.id(8041003319413487)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8043435887413486)
,p_plug_template_id=>wwv_flow_imp.id(8041003319413487)
,p_name=>'Sub Regions'
