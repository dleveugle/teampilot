...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(8013135191413498)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8013441586413498)
,p_plug_template_id=>wwv_flow_imp.id(8013135191413498)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8013782156413498)
,p_plug_template_id=>wwv_flow_imp.id(8013135191413498)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8014061041413498)
,p_plug_template_id=>wwv_flow_imp.id(8013135191413498)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8014347452413497)
,p_plug_template_id=>wwv_flow_imp.id(8013135191413498)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8014676598413497)
,p_plug_template_id=>wwv_flow_imp.id(8013135191413498)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8014944812413497)
,p_plug_template_id=>wwv_flow_imp.id(8013135191413498)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8015206819413497)
,p_plug_template_id=>wwv_flow_imp.id(8013135191413498)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8015562135413497)
,p_plug_template_id=>wwv_flow_imp.id(8013135191413498)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8015835344413497)
,p_plug_template_id=>wwv_flow_imp.id(8013135191413498)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8016151451413497)
,p_plug_template_id=>wwv_flow_imp.id(8013135191413498)
,p_name=>'Sub Regions'
