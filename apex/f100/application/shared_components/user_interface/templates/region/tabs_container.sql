...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(8070689063413476)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8070984302413475)
,p_plug_template_id=>wwv_flow_imp.id(8070689063413476)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8071274468413475)
,p_plug_template_id=>wwv_flow_imp.id(8070689063413476)
,p_name=>'Tabs'
