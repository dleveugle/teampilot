...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(8055644832413481)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8055908767413481)
,p_plug_template_id=>wwv_flow_imp.id(8055644832413481)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8056298280413481)
,p_plug_template_id=>wwv_flow_imp.id(8055644832413481)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8056572991413481)
,p_plug_template_id=>wwv_flow_imp.id(8055644832413481)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8056870011413481)
,p_plug_template_id=>wwv_flow_imp.id(8055644832413481)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8057106595413481)
,p_plug_template_id=>wwv_flow_imp.id(8055644832413481)
,p_name=>'Sub Regions'
