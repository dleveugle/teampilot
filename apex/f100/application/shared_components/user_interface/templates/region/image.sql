...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(8031042133413491)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8031333472413491)
,p_plug_template_id=>wwv_flow_imp.id(8031042133413491)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8031613597413491)
,p_plug_template_id=>wwv_flow_imp.id(8031042133413491)
,p_name=>'Sub Regions'
