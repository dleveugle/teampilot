...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(8022937752413494)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8023249339413494)
,p_plug_template_id=>wwv_flow_imp.id(8022937752413494)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8023501131413494)
,p_plug_template_id=>wwv_flow_imp.id(8022937752413494)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8023821080413494)
,p_plug_template_id=>wwv_flow_imp.id(8022937752413494)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8024107635413494)
,p_plug_template_id=>wwv_flow_imp.id(8022937752413494)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8024495149413493)
,p_plug_template_id=>wwv_flow_imp.id(8022937752413494)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8024713013413493)
,p_plug_template_id=>wwv_flow_imp.id(8022937752413494)
,p_name=>'Sub Regions'
