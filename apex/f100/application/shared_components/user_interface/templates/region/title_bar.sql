...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(8073238746413474)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8073538696413474)
,p_plug_template_id=>wwv_flow_imp.id(8073238746413474)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8073877287413474)
,p_plug_template_id=>wwv_flow_imp.id(8073238746413474)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8074195130413474)
,p_plug_template_id=>wwv_flow_imp.id(8073238746413474)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8074495934413474)
,p_plug_template_id=>wwv_flow_imp.id(8073238746413474)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8074777395413474)
,p_plug_template_id=>wwv_flow_imp.id(8073238746413474)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8075014081413474)
,p_plug_template_id=>wwv_flow_imp.id(8073238746413474)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8075303290413474)
,p_plug_template_id=>wwv_flow_imp.id(8073238746413474)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8075683665413474)
,p_plug_template_id=>wwv_flow_imp.id(8073238746413474)
,p_name=>'Help'
,p_placeholder=>'HELP'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8075963620413474)
,p_plug_template_id=>wwv_flow_imp.id(8073238746413474)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8076221343413473)
,p_plug_template_id=>wwv_flow_imp.id(8073238746413474)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8076527903413473)
,p_plug_template_id=>wwv_flow_imp.id(8073238746413474)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8076898686413473)
,p_plug_template_id=>wwv_flow_imp.id(8073238746413474)
,p_name=>'Sub Regions'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8077145358413473)
,p_plug_template_id=>wwv_flow_imp.id(8073238746413474)
,p_name=>'Up'
,p_placeholder=>'UP'
,p_has_grid_support=>false
