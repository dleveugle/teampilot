...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(8058156046413480)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8058464363413480)
,p_plug_template_id=>wwv_flow_imp.id(8058156046413480)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8058787737413480)
,p_plug_template_id=>wwv_flow_imp.id(8058156046413480)
,p_name=>'Search Field'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(8059086601413480)
,p_plug_template_id=>wwv_flow_imp.id(8058156046413480)
,p_name=>'Sub Regions'
